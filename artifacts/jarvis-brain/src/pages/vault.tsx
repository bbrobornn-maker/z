...
export default function Vault() {
  ...
  const { data: vault } = useGetVault(id, { query: { enabled: !!id } });
  const { data: notes, isLoading } = useGetVaultNotes(id, {
    query: { enabled: !!id, queryKey: getGetVaultNotesQueryKey(id) },
  });
  ...
  const handleCreate = (e: React.FormEvent) => {
    ...
    createNote.mutate(
      ...
      {
        onSuccess: () => {
          queryClient.invalidateQueries({ queryKey: getGetVaultNotesQueryKey(id) });
